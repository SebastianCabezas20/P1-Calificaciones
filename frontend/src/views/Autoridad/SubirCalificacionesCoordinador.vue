  ...
  <div class="contentViews">
    <div class="centralContent">
      ...
      <form @submit.prevent="submitCalificaciones" action="POST">
        ...
        <template v-if="calificacionesEstudiantes.length !== 0">
          <div>
      ...
      axios
        ...
        .then(function (response) {
          that.$swal
            ...
            .then((result) => {
              that.$router.push({ path: `/coordinador/asignatura/${that.calificacionesEstudiantes[0].id_coordinacion.id_asignatura.id}/seccion/${that.idCurso}` });
            });
        });
    },
  },
